...
def pinjam(user_name , identity , datas_gadget , buku_hutang_li , gadget_borrow_history):
    ...
    if not exist:
        ...
        datas_gadget[index_id][3] = int(datas_gadget[index_id][3]) - jumlah_pinjam
...
def kembalikan(user_name , user_identity , datas_gadget , buku_hutang_li , gadget_borrow_history , gadget_return_history):
    ...
    datas_gadget[index_barang][3] = str(int(datas_gadget[index_barang][3]) + jumlah_return)                                                 #stok gadget bertambah setelah dikembalikan
